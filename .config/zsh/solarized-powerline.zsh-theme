...
# If there is no repo don't bother
    ...
    if $DIRTY; then
        ...
        # Styling for the separator after the git symbol
        R_SEPERATOR=${R_SEGMENT_SEPARATOR}
        R_SEPARATOR_COLOR=${POWERLINE_GIT_SUFFIX_BG_COLOR}
    else
        BG_COLOR=${POWERLINE_GIT_STATUS_CLEAN_BG_COLOR}
        TEXT_COLOR=${POWERLINE_GIT_STATUS_CLEAN_TEXT_COLOR}
        # Styling for the separator after the git symbol
        R_SEPERATOR=${R_SEGMENT_CLEAN_SEPARATOR}
        R_SEPARATOR_COLOR=${POWERLINE_GIT_SUFFIX_TEXT_COLOR}
    fi
    ...
    #
    GIT_LINE="${GIT_LINE}%F{${R_SEPARATOR_COLOR}}${R_SEPERATOR}"
